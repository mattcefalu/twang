---
title: "New features in twang 2.0"
...
4. The default shrinkage value differs for **gbm** and **xgboost** to account for differences in the algorithms.
...
M3<-ps(treat~age+black+hispan+married+nodegree+re74+re78 , data=lalonde , verbose=F,
       n.trees=5000 , shrinkage = 0.01 , interaction.depth = 3, version="xgboost")
M4<-ps(treat~age+black+hispan+married+nodegree+re74+re78 , data=lalonde , verbose=F,
       nrounds=5000 , eta = 0.01 , max_depth = 3, min_child_weight=10, version="xgboost")
M5<-ps(treat~age+black+hispan+married+nodegree+re74+re78 , data=lalonde , verbose=F, 
       nrounds=5000 , params=list(eta = 0.01 , max_depth = 3 , min_child_weight=10) , version="xgboost")
